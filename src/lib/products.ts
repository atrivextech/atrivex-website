...
export const products: Product[] = [
  ...
  },
  {
    ...
    status: 'live',
    category: 'Workforce',
    externalUrl: 'https://play.google.com/store/apps/details?id=com.atrivex.atriwork',
