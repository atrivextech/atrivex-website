...
export const metadata: Metadata = {
  ...
  description: 'Legal disclosure (Impressum) for Atrivex Technology Private Limited as required under German TMG and Indian Companies Act.',
}
    ...
    <div className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-10 text-sm">
          Legal Disclosure pursuant to &sect;5 TMG (German Telemedia Act)
        </p>

        {/* Provider Information */}
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">Provider Information (Angaben gem&auml;&szlig; &sect;5 TMG)</h2>
        ...
        {/* Contact */}
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">Contact Information (Kontakt)</h2>
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-100 dark:border-gray-800 space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <p><span className="font-medium text-gray-900 dark:text-white">Email:</span>{' '}
              <a href="mailto:sales@atrivextech.com" className="text-primary-600 dark:text-primary-400 hover:underline">
                sales@atrivextech.com
              </a>
            </p>
        ...
        {/* Represented by */}
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">Represented By (Vertreten durch)</h2>
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-100 dark:border-gray-800 text-gray-700 dark:text-gray-300">
            <p className="font-semibold text-gray-900 dark:text-white">Vinayak K V</p>
            <p>Director</p>
          </div>
        </section>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">Responsible for Content (Verantwortlich f&uuml;r den Inhalt gem&auml;&szlig; &sect;18 Abs. 2 MStV)</h2>
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-100 dark:border-gray-800 text-gray-700 dark:text-gray-300">
            <p className="font-semibold text-gray-900 dark:text-white">Vinayak K V</p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">Liability for Content (Haftung f&uuml;r Inhalte)</h2>
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
            As a service provider, we are responsible for our own content on these pages in accordance with
            general laws pursuant to &sect;7 (1) TMG. According to &sect;&sect;8-10 TMG, however, we are not
            ...
            laws remain unaffected. Liability in this regard is only possible from the point of knowledge of a
            specific infringement. Upon becoming aware of corresponding infringements, we will remove this
            content immediately.
          </p>
        </section>
        ...
        {/* Liability for Links */}
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">Liability for Links (Haftung f&uuml;r Links)</h2>
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
            ...
            operator of the pages is always responsible for the content of the linked pages. The linked pages were
            checked for possible legal violations at the time of linking. Illegal content was not recognizable at
            the time of linking. Permanent monitoring of the content of the linked pages is not reasonable without
            concrete evidence of a violation. Upon becoming aware of legal violations, we will remove such links
            immediately.
          </p>
        </section>
        ...
        {/* Copyright */}
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">Copyright (Urheberrecht)</h2>
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
            The content and works on these pages created by the site operator are subject to Indian and international
            copyright law. Duplication, processing, distribution, or any form of commercialization of such material
